# Chatbot UI - Modified Version (No Authentication Required)

This is a modified version of the original Chatbot UI that has been adapted to work without Supabase authentication. All Supabase-related functionality has been replaced with mock implementations, making it easier to run locally and deploy without setting up a database.

## Modifications Made

- Removed Supabase authentication requirements
- Added mock implementations for user profiles, workspaces, chats, and messages
- Simplified deployment by eliminating database dependencies
- Provides a demo user experience out of the box

## Deployment

This modified version can be deployed to platforms like Vercel or Netlify without any additional configuration for authentication or databases.

---

# Original Documentation

# Chatbot UI (Modified Version)

This is a modified version of the original [Chatbot UI](https://github.com/mckaywrigley/chatbot-ui) project with Supabase authentication removed for simpler local usage.
...
- Remove all authentication requirements (no login needed)
- Use an in-memory data store instead of Supabase
- Simplify the UI and navigation
- Make it easier to run locally without database setup
...
```bash
git clone https://github.com/yourusername/chatbot-ui-modified.git
```
...
This modified version still maintains most of the core features of Chatbot UI:
...
However, all features that required authentication and persistent storage have been simplified to work with an in-memory store.

## Environment Variables

You can still configure API keys for various models by setting up a .env.local file with your API keys:
...
This project is based on [Chatbot UI](https://github.com/mckaywrigley/chatbot-ui) by Mckay Wrigley.
